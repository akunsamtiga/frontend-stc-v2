    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white">Manajemen Verifikasi</h1>
            <p className="text-sm text-slate-400 mt-1">Tinjau dan setujui verifikasi pengguna</p>
          </div>
          <button
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10 backdrop-blur-sm">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-8 h-8 rounded bg-blue-500/10 flex items-center justify-center">
                <CreditCard className="w-5 h-5 text-blue-400" weight="duotone" />
              </div>
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10 backdrop-blur-sm">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-8 h-8 rounded bg-sky-500/10 flex items-center justify-center">
                <Camera className="w-5 h-5 text-sky-400" weight="duotone" />
              </div>
        ...
        {/* Tabs */}
        <div className="inline-flex bg-white/5 rounded-lg p-1 border border-white/10 mb-6">
          <button
        ...
        {selectedTab === 'ktp' ? (
            ...
            {filteredKTP.length === 0 ? (
              <div className="bg-white/5 rounded-lg p-12 text-center border border-white/10 backdrop-blur-sm">
                <div className="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mx-auto mb-4 border border-white/10">
                  <CreditCard className="w-8 h-8 text-slate-500" weight="duotone" />
                </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-blue-500/10 rounded-full flex items-center justify-center flex-shrink-0 border border-blue-500/20">
                        <User className="w-6 h-6 text-blue-400" weight="duotone" />
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <CalendarBlank className="w-4 h-4 text-slate-500" weight="duotone" />
          ...
          <div className="space-y-3">
            {filteredSelfie.length === 0 ? (
              <div className="bg-white/5 rounded-lg p-12 text-center border border-white/10 backdrop-blur-sm">
                <div className="w-16 h-16 bg-white/5 rounded-xl flex items-center justify-center mx-auto mb-4 border border-white/10">
                  <Camera className="w-8 h-8 text-slate-500" weight="duotone" />
                </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-sky-500/10 rounded-full flex items-center justify-center flex-shrink-0 border border-sky-500/20">
                        <User className="w-6 h-6 text-sky-400" weight="duotone" />
                      </div>
                      <div>
                        <h3 className="font-bold text-white">{verification.fullName || 'Tanpa Nama'}</h3>
                        <p className="text-sm text-slate-400">{verification.email}</p>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-sky-500/10 hover:bg-sky-500/20 text-sky-400 border border-sky-500/20 rounded-lg transition-colors"
                    >
                      <Eye className="w-4 h-4" weight="duotone" />
                      Tinjau
                    </button>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-3 focus:border-blue-500 focus:bg-white/10 transition-all focus:outline-none text-white placeholder-slate-500 resize-none"
                    rows={3}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-3 focus:border-red-500 focus:bg-white/10 transition-all focus:outline-none text-white placeholder-slate-500 resize-none"
                    rows={3}
                  />
                </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setAdminNotes(e.target.value)}
                    placeholder="Tambahkan catatan tentang verifikasi ini..."
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-3 focus:border-sky-500 focus:bg-white/10 transition-all focus:outline-none text-white placeholder-slate-500 resize-none"
                    rows={3}
                  />
                </div>

...
const StatCardSkeleton = () => (
  <div className="flex items-center gap-3 sm:gap-4 animate-pulse">
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="h-5 sm:h-6 bg-gray-200 rounded w-20 sm:w-32"></div>
    </div>
  </div>
)
  ...
  <div className="min-h-screen bg-[#fafafa]">
    ...
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-8 max-w-7xl">
      <div className="mb-4 sm:mb-6 animate-pulse">
        <div className="h-2.5 sm:h-3 bg-gray-200 rounded w-36 sm:w-48 mb-2 sm:mb-3"></div>
      ...
      {/* Stats Skeleton - Mobile: 2 columns, Tablet: 3 columns, Desktop: 5 columns */}
      <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 lg:p-6 mb-4 sm:mb-6">
      ...
      {/* Filters Skeleton */}
      <div className="bg-white rounded-xl p-3 sm:p-4 lg:p-5 border border-gray-200 mb-4 sm:mb-6 animate-pulse">
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-8 sm:h-9 bg-gray-200 rounded-lg w-16 sm:w-20 flex-shrink-0"></div>
            ))}
          </div>
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {[...Array(4)].map((_, i) => (
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-8 max-w-7xl">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-3 flex-wrap">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Trading History</h1>
            ...
            <button
              ...
              disabled={refreshing}
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-colors"
            >
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 lg:p-6 mb-4 sm:mb-6 shadow-sm">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5 lg:gap-6">
            {/* Total P&L */}
            <div className="flex items-center gap-3 sm:gap-4 col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-base sm:text-lg font-bold text-green-600">{stats.won}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-base sm:text-lg font-bold text-red-600">{stats.lost}</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-base sm:text-lg font-bold text-yellow-600">{winRate}%</div>
              </div>
            </div>
          </div>
        </div>

        {/* Filters - Mobile: Stacked, Tablet+: Row */}
        <div className="bg-white rounded-xl p-3 sm:p-4 lg:p-5 border border-gray-200 mb-4 sm:mb-6 shadow-sm">
            ...
            <div className="text-center py-12 sm:py-16 lg:py-20 px-4">
              ...
              {statusFilter === 'all' && accountFilter === 'all' && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-blue-500 text-white rounded-lg text-xs sm:text-sm font-medium hover:bg-blue-600 active:bg-blue-700 transition-colors"
                >
            ...
            <>
              ...
              <div className="lg:hidden space-y-2 sm:space-y-3 p-3 sm:p-4">
                {orders.map((order) => (
                  <div
                    key={order.id}
                    className="bg-gray-50 border border-gray-100 rounded-xl p-3 sm:p-4 hover:shadow-md active:shadow-lg transition-shadow"
                  >
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                            ...
                            <span className={`px-1.5 sm:px-2 py-0.5 rounded text-xs font-bold flex-shrink-0 ${
                              (order.accountType || 'demo') === 'real'
                                ? 'bg-green-100 text-green-700'
                                : 'bg-blue-100 text-blue-700'
                            }`}>
                      ...
                      <span className={`px-2 sm:px-3 py-1 rounded-lg text-xs font-bold flex-shrink-0 ml-2 ${
                        order.status === 'WON' ? 'bg-green-100 text-green-700' :
                        order.status === 'LOST' ? 'bg-red-100 text-red-700' :
                        order.status === 'ACTIVE' ? 'bg-blue-100 text-blue-700' :
                        'bg-gray-100 text-gray-700'
                    ...
                    {order.profit !== null && order.profit !== undefined && (
                      <div className="bg-white rounded-lg p-2 sm:p-3 flex items-center justify-between">
              ...
              {/* Pagination */}
              {totalPages > 1 && (
                <div className="border-t border-gray-200 px-3 sm:px-4 py-4 sm:py-5">
                      ...
                      <div className="flex items-center gap-1">
                        {[...Array(totalPages)].map((_, index) => {
                          ...
                          if (
                            ...
                            return (
                              <span key={page} className="px-1 sm:px-2 text-gray-400 hidden sm:inline">
                                ...
                              </span>
                            )
                          }

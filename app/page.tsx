          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="bg-background-secondary/50 backdrop-blur-sm border border-gray-800 rounded-xl p-4 sm:p-6 hover:border-primary/30 transition-colors">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="group bg-background-secondary border border-gray-800 rounded-2xl p-6 sm:p-8 hover:border-primary/50 transition-all hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <button
                ...
                className="mt-8 px-8 py-4 bg-white/5 hover:bg-white/10 border border-gray-700 hover:border-primary/50 rounded-xl text-lg font-semibold transition-all inline-flex items-center gap-2"
              >
                Explore Platform
                <ArrowRight className="w-5 h-5" />
              </button>
                ...
                <div className="bg-background rounded-2xl p-6">
                  ...
                  <div className="h-48 bg-background-tertiary rounded-xl mb-6 flex items-end justify-around p-4">
                    {[40, 65, 45, 80, 55, 90, 70, 85, 60, 95].map((height, i) => (
                      <div key={i} className="w-full mx-1 bg-gradient-to-t from-success/50 to-success rounded-t" style={{ height: `${height}%` }}></div>
                    ))}
                  </div>

          ...
          <div className="hidden lg:block lg:col-span-4 space-y-6">
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 break-all">{user.email}</h3>
                ...
                <div className="p-5 sm:p-6 space-y-4">
                  <div className="p-5 rounded-xl border border-gray-200 hover:border-gray-300 active:border-gray-400 transition-colors">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-xs text-gray-500 mb-1 font-medium">Email Address</div>
                        <div className="text-base font-semibold text-gray-900 truncate">{user.email}</div>
                      </div>
                      <div className="flex items-center gap-2 px-3 py-1 bg-green-50 border border-green-200 rounded-full flex-shrink-0">
                  ...
                  <div className="p-5 rounded-xl border border-gray-200 hover:border-gray-300 active:border-gray-400 transition-colors">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="text-xs text-gray-500 mb-1 font-medium">Account Type</div>
                        <div className="text-base font-semibold text-gray-900 capitalize">{user.role.replace('_', ' ')}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-5 rounded-xl border border-gray-200 hover:border-gray-300 active:border-gray-400 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${
                        ...
                        <div className={`w-6 h-6 rounded-full ${user.isActive ? 'bg-green-500' : 'bg-red-500'}`}></div>
                      </div>
                      <div className="flex-1">
                        <div className="text-xs text-gray-500 mb-1 font-medium">Account Status</div>
                        <div className={`text-base font-semibold ${user.isActive ? 'text-green-700' : 'text-red-700'}`}>
                  ...
                  <div className="p-5 rounded-xl border border-gray-200 hover:border-gray-300 active:border-gray-400 transition-colors">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="text-xs text-gray-500 mb-1 font-medium">Member Since</div>
                  ...
                  <div className="p-5 rounded-xl border border-gray-200 hover:border-gray-300 active:border-gray-400 transition-colors">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-4 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-semibold text-gray-900 mb-1">Trade Alerts</div>
